...
### 完了
- プロンプトインジェクション調査：8件の主要事例 + OpenClawの現状分析
- OpenClaw公式のセキュリティ体制：160件超のアドバイザリ分析
- **プロンプトインジェクション テストガイド**: [27の攻撃テスト](test-cases/prompt-injection-guide.md)（初級〜上級）
- **AuditClawスキャン**: PIリスク評価付き[セキュリティセルフスキャン](skill/README.md)
