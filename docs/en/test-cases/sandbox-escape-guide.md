...
- **Vulnerability Documentation**:
  ...
  - [TOCTOU Vulnerabilities](../vulnerabilities/toctou.md)
  - [ACP Security](../vulnerabilities/acp-security.md)
  - [Path Traversal](../vulnerabilities/path-traversal.md)
- **Best Practices**:
  - [Hardening Guide - Sandbox Configuration](../best-practices/hardening-guide.md#sandbox-configuration)
- **Test Cases**: Available in repository `tests/sandbox-escape/` directory
- **Official Documentation**: [OpenClaw Sandbox Architecture](https://openclaw.ai/docs/security/sandbox)
...
```bash
# Example: Run Test 1 (Dangling Symlink Bypass)
cd test-01-dangling-symlink
./run.sh

# Check results
echo $?  # 0 = secure (test failed to bypass), 1 = vulnerable
```
